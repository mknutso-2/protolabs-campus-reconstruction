...
Open the [public exterior walkthrough](https://protolabs-campus-mknutso.mknutso2.chatgpt.site) or its [accuracy and sources page](https://protolabs-campus-mknutso.mknutso2.chatgpt.site/accuracy.html). The published viewer uses the inspected model, stills and film.
...
| [Public site publication](docs/site-publication.md) | Live URL, exact saved version and public-access verification |
